...
extension UIAlertController {
    ...
    class func showAlert(_ controller: UIViewController?, title: String? = Strings.paulGifty, message: String?) {
        
        showAlert(controller, title: title, message: message, preferredStyle: .alert, sender: nil, actions: .OK, handler: nil)
    }
    
    class func showAlert(_ controller: UIViewController? = nil, title: String? = Strings.paulGifty, message: String?, preferredStyle: UIAlertController.Style = .alert, sender: AnyObject? = nil, actions: AlertAction..., handler: AlertHandler?) {
    ...
    class func showInputAlert(_ controller: UIViewController?, title: String? = Strings.paulGifty, message: String?, inputPlaceholders: [String]? = nil, inputTexts: [String]? = nil, preferredStyle: UIAlertController.Style = .alert, sender: AnyObject? = nil, actions: AlertAction..., handler: AlertInputHandler?) {
